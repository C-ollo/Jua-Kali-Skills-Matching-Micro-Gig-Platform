...
import { getArtisanById } from '../api/artisans';
...
function ArtisanProfilePage() {
  ...
  useEffect(() => {
    const fetchArtisan = async () => {
      try {
        const response = await getArtisanById(artisan_id);
          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="flex flex-col gap-10 px-4 py-10 @container">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[#8a6a60] text-base font-normal leading-normal">{artisan.location}</p>
              </div>
              <div className="flex flex-col gap-4">
                <h2 className="text-[#181211] text-xl font-bold leading-tight">Skills</h2>
              ...
              <div className="flex flex-col gap-4">
                <h2 className="text-[#181211] text-xl font-bold leading-tight">About Me</h2>
                <p className="text-[#181211] text-base font-normal leading-normal">{artisan.artisan_details?.bio}</p>
              </div>
              <div className="flex flex-col gap-4">
                <h2 className="text-[#181211] text-xl font-bold leading-tight">Contact Information</h2>
                <p className="text-[#181211] text-base font-normal leading-normal">Email: {artisan.email}</p>
                <p className="text-[#181211] text-base font-normal leading-normal">Phone: {artisan.phone_number}</p>
              </div>
            </div>
          </div>
        </div>
